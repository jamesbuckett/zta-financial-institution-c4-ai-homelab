...
printf '\n== 1. ConstraintTemplate is Established ==\n'
...
printf '\n== 2. K8sRequiredZtaLabels CRD is registered ==\n'
...
printf '\n== 3. Constraint requires the three ZTA labels ==\n'
...
printf '\n== 4. Webhook failure policy is Fail (fail-closed) ==\n'
...
printf '\n== 5. Audit reports zero existing violations ==\n'
kubectl --context docker-desktop get k8srequiredztalabels bookstore-resources-labelled \
